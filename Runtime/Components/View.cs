...
namespace UCGUI
{
    ...
    /// </para>
    public partial class View : ImageComponent, IRenderable
    {
        ...
        /// <returns></returns>
        public View Add(params BaseComponent[] components)
        {
        ...
        /// <returns></returns>
        public View Add(BaseComponent component)
        {
        ...
        /// <returns></returns>
        public View ToggleUsing(InputAction toggle)
        {
        ...
        /// <returns></returns>
        public View OpenUsing(InputAction open)
        {
            _openAction = open;
        ...
        /// <returns></returns>
        public View CloseUsing(InputAction close)
        {
            _openAction = close;
        ...
        /// <returns></returns>
        public View Link(Canvas canvas)
        {
            _canvas = canvas;
        ...
        /// <summary>
        /// Invoked when a <see cref="ViewStack"/> pushes this view.
        /// </summary>
        /// <param name="stack">The stack pushing the view.</param>
        /// <returns></returns>
        public View OnStackJoined(ViewStack stack)
        {
            _viewStack = stack;
            return this;
        }
        /// <summary>
        /// Invoked when a <see cref="ViewStack"/> pops this view.
        /// </summary>
        /// <returns></returns>
        public View OnStackLeft()
        {
            _viewStack = null;
            return this;
        }
        ...
        public partial class ViewBuilder
        {
            ...
            public ViewBuilder(View view, Canvas canvas) : this(view)
            {
                view.Link(canvas);
            }
            /// <inheritdoc cref="View.ToggleUsing"/>
            public void ToggleUsing(InputAction toggle) => _view.ToggleUsing(toggle);
            
            /// <inheritdoc cref="View.OpenUsing"/>
            public void OpenUsing(InputAction open) => _view.OpenUsing(open);
            /// <inheritdoc cref="View.CloseUsing"/>
            public void CloseUsing(InputAction close) => _view.CloseUsing(close);

            /// <see cref="View.Add(UCGUI.BaseComponent[])"/>
            public void Add(params BaseComponent[] contents) => _view.Add(contents);

            /// <inheritdoc cref="View.Lock"/>
            public void Lock() => _view.Lock();

            /// <summary>
            /// Sets whether the view closes automatically when tapping on its background.
            /// </summary>
            /// <param name="closes">Boolean controlling <see cref="View.closesOnBackgroundTap"/></param>.
            public void CloseOnBackgroundTap(bool closes = true) => _view.closesOnBackgroundTap = closes;
            
            /// <inheritdoc cref="View.StartOpen"/>
            public void StartOpen() => _view.StartOpen();

            /// <inheritdoc cref="View.EventOpen"/>
            public void EventOpen() => _view.EventOpen();
            
            /// <inheritdoc cref="View.EventClose"/>
            public void EventClose() => _view.EventClose();
            
            /// <inheritdoc cref="View.Events"/>
            public void Events() => _view.Events();
        }
    }
}